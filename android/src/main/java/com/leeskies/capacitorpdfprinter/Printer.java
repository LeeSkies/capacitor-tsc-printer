...
public class Printer {
    ...
    public void printPdf(int port, String IPAddress, String base64String, int x, int y, int width, int height, int dpi, PluginCall call) {
        ...
        // Use AtomicBoolean to handle the mutable value across threads
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    connectionOpened.set(true);  // Set the value to true
                    ...
                    if (connectionOpened.get()) {  // Access the value using `get()`
                        try {
                            tsc.clearbuffer();
                            tsc.closeport(port);
                        } catch (Exception e) {
